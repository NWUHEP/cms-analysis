...
# with command line options: heavyB_step3 --filein file:heavyB_step2_RAW2DIGI_L1Reco_RECO_EI_DQM.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_miniAODv2_v0 --step PAT --era Run2_25ns -n 5 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(),#('file:heavyB_step2_RAW2DIGI_L1Reco_RECO_EI_DQM.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('heavyB_step3 nevts:5'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('heavyB_step3_PAT.root'),
