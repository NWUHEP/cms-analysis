...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(),#('file:PYTHIA8_heavyB2Xb_mumu_13TeV_cff_py_GEN_SIM.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('heavyB_step1 nevts:5'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('heavyB_step1_DIGI_L1_DIGI2RAW_HLT_PU.root'),
