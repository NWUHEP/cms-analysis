...
# with command line options: STEP2 --step RAW2DIGI,L1Reco,RECO,VALIDATION:validation_prod --conditions START53_V27::All --pileup 2012_Summer_50ns_PoissonOOTPU --pileup_input dbs:/RelValMinBias/CMSSW_5_2_1-START52_V4-v1/GEN-SIM --datamix NODATAMIXER --eventcontent AODSIM --datatier AODSIM --filein file:REDIGI_DIGI_L1_DIGI2RAW_HLT_PU.root --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:heavyB_REDIGI_DIGI_L1_DIGI2RAW_HLT_PU.root')
)
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('heavyB_STEP2_RAW2DIGI_L1Reco_RECO_VALIDATION_PU.root'),
