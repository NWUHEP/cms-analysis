...
config.General.requestName = 'BPrime2Xb_X2ll_muonChannel_13TeV_step1'
config.General.workArea = 'crab_dimuon_13TeV'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'heavyB_step1_DIGI_L1_DIGI2RAW_HLT_PU.py'
...
NJOBS = 237  # This is not a configuration parameter, but an auxiliary variable that we use in the next line.
config.Data.totalUnits = config.Data.unitsPerJob * NJOBS
config.Data.outLFNDirBase = '/store/user/%s/' % (getUsernameFromSiteDB())
config.Data.publication = True
config.Data.outputDatasetTag = 'BPrime2Xb_X2ll_muonChannel_13TeV_step1'
